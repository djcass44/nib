...
require (
	github.com/Snakdy/container-build-engine v0.1.7-0.20240701222501-bfb0afbe6479
...
require (
	...
	github.com/chainguard-dev/go-apk v0.0.0-20240605175618-f3471089c263 // indirect
